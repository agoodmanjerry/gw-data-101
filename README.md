...
### 4. Finding and reading time series data
### 5. Estimating Power Spectral Density (PSD) from the time series data
### 6. Simulating waveforms of the Compact Binary Coalescence (CBC) events
### 7. Matched filtering using PyCBC
### 8. Parameter Estimation (PE) using Bilby
